...
module "docdb" {
  source = "github.com/pavanikakarlapudi/tf-module-docdb"
  env    = var.env
...
module "rds" {
  source = "github.com/pavanikakarlapudi/tf-module-rds"
  env    = var.env
...
module "elasticache" {
  source = "github.com/pavanikakarlapudi/tf-module-elasticache"
  env    = var.env
...
module "rabbitmq" {
  source       = "github.com/pavanikakarlapudi/tf-module-rabbitmq"
  env          = var.env
...
module "alb" {
  source = "github.com/pavanikakarlapudi/tf-module-alb"
  env    = var.env
...
module "apps" {
  source = "github.com/pavanikakarlapudi/tf-module-app"
  env    = var.env
